                ...
                fluidRow(
                  ...
                  column(width=4, align="center",
                         ...
                         box(width = "100%", background = "navy",
                             h1("Ryan Yu"),
                             tags$hr(style = "width: 30%;height: 2px;"),
                             p("Ryan is an undergrad in the class of 2025 at Duke University, studying Computer Science and Statistical Science. He enjoys opportunities like this Data+ project where skills gained in class are applied to real-life scenarios." ,style="text-align:left;padding:5px;border-radius:10px"))),
                  )
